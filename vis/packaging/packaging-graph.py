...
df = pd.read_csv("C:\\Users\\ismae\\Documents\\GitHub\\dataseeds.github.io\\vis\\packaging\\packaging-waste-recycling.csv")
...
fig.add_trace(
    go.Table(
        header=dict(values=df.columns[1:].tolist(), font=dict(size=10), align="center"),
        cells=dict(
...
fig.write_html("C:\\Users\\ismae\\Documents\\GitHub\\dataseeds.github.io\\vis\\packaging.html",
               config=conf)